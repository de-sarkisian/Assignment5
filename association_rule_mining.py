...
#Debug Statememnt to check if the encoding is correct
#print(encoded_vals)
...
#    print("Prior: {}".format(row["consequent support"]))
#    print("Gain in Confidence: {}".format(str(100*(row["confidence"]-row["consequent support"]/row["consequent support"]))))
    
#print('#',rules['consequents'][index], '->' , rules['antecedents'][index])
#print('Support:', rules[3])
#print('Confidence:', rules[4])
#print('Prior:', rules[5])
#print('Gain in Confidence:', rules[6])
